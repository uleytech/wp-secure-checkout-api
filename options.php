...
function register_settings()
{
    ...
    add_settings_field('wp_init_affiliate_id_setting_api_key', 'API Key', 'wp_secure_checkout_api_setting_api_key', 'wp_secure_checkout_api', 'api_settings');
}
...
function wp_init_affiliate_id_setting_api_key()
{
